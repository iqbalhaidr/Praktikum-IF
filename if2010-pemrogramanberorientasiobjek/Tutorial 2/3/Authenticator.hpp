...
class Authenticator {
   private:
    ...
    string secretResource;  // Resource rahasia yang hanya bisa diakses oleh
                            // user yang login
   ...
   public:
     ...
     * sistem.
     * - "Sukses: User <username> berhasil terdaftar!" jika pendaftaran
     * berhasil.
     ...
     *
     * Output:
     * - "Akses ditolak! Silakan login terlebih dahulu." jika tidak ada user
     * yang login.
