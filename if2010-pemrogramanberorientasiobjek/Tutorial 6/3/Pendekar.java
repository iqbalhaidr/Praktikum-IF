...
public class Pendekar implements Kelas {
    ...
    public void serang(Karakter self, Karakter target) {
        String s = self.getName() + ", sang pendekar, menyerang " + target.getName() + " dengan " + this.senjata;
    ...
    public void gunakanUltimate(Karakter self, Karakter target) {
        if (target.isHidup()) {
            String karName = self.getName();
            System.out.println(karName + " menyerukan nada peperangan");
            System.out.println(karName + " mendapatkan 30 health dan 20 mana");
            System.out.println(karName + " menyerang " + target.getName() + " dengan " + this.senjata + " dan " + this.perisai);
